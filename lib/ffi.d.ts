 ...
 */
export type LibraryObject<T extends LibraryDefinitionBase> = [T] extends [never] | [0]
    ? any // catches T extends never/any (since `0` doesn't overlap with our constraint)
    : {
          [P in keyof T]: T[P][2] extends undefined
              ...
              : T[P][2] extends { promise: true }
              ? ForeignFunction<ref.UnderlyingType<T[P][0]>, ref.UnderlyingTypes<T[P][1]>>['promise']
...
export interface Function<TReturnType extends ref.Type = ref.Type, TArgTypes extends ref.Type[] = ref.Type[]>
